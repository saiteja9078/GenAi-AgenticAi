...
The functional EPI images covered the entire brain (TR, 2000 ms; TE, 43 ms; flip angle, 80Â°; voxel size, 2 Ã— 2 Ã— 2 mm; FOV, 192 Ã— 192 mm; number of slices, 76; slice gap, 0 mm; multiband factor, 4) and inplane T2-weighted anatomical images were acquired with the same slices used for the EPI (TR, 11,000 ms; TE, 59 ms; flip angle, 160Â°; voxel size, 0.75 Ã— 0.75 Ã— 2.0 mm; FOV, 192 Ã— 192 mm).
The dataset also includes a T1-weighted anatomical reference image for each subject (TR, 2250 ms; TE, 3.06 ms; TI, 900 ms; flip angle, 9Â°; voxel size, 1.0 Ã— 1.0 Ã— 1.0 mm; FOV, 256 Ã— 256 mm).
